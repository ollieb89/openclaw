...
export const FIELD_LABELS: Record<string, string> = {
  ...
  security: "Security",
  "security.inputDetection": "Input Detection",
  "security.inputDetection.defaultSensitivity": "Default Input Sensitivity",
  "security.inputDetection.channels": "Per-Channel Input Sensitivity",
